...
class Post(models.Model):
    ...
    title = models.CharField(max_length=20, verbose_name="标题", default=None)
    # 规定注册了的用户才能投稿
    ...
    # slug = models.SlugField(verbose_name="子模型名", max_length=100, default=None, null=True, blank=True)
...
class Opensource(Post):
    ...
    type = models.CharField(max_length=10, verbose_name="分类", choices=categories, default=None)
...
class Programming(Post):
    ...
    type = models.CharField(choices=category, verbose_name="编程语言", max_length=10, default=None)
    description = MDTextField(verbose_name="软件描述")
